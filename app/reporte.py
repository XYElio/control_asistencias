...
def obtener_estadisticas_profesor():
    """Obtiene estadísticas detalladas por profesor"""
    query = """
    SELECT 
...
def obtener_estadisticas_materia():
    """Obtiene estadísticas detalladas por materia"""
    query = """
    SELECT 
        m.nombre as materia,
        c.nombre as carrera,
...
def crear_grafica_carreras(df):
    """Crea una gráfica de barras para estadísticas por carrera"""
    fig = go.Figure()
...
def crear_grafica_profesores(df):
    """Crea una gráfica de barras para estadísticas por profesor"""
    fig = go.Figure()
...
def crear_grafica_materias(df):
    """Crea una gráfica de barras para estadísticas por materia"""
    fig = go.Figure()
